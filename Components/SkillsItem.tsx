...
const SkillsItem = ({title, year}: Props) => {
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
      ...
      <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
        Nesciunt debitis perspiciatis, alias cupiditate quasi eaque facilis cumque, 
        consectetur accusantium voluptas ipsam ea?
      </p>
    </div>
  )
}
